...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const PRODUCT_API_BASE_URL  = window.ENV.PRODUCT_API_URL;
    const ORDER_API_BASE_URL    = window.ENV.ORDER_API_URL;
    const CUSTOMER_API_BASE_URL = window.ENV.CUSTOMER_API_URL;
